...
tsl_debug_append_path(StringInfo buf, PlannerInfo *root, Path *path, int indent)
{
	...
	switch (nodeTag(path))
	{
		...
		case T_CustomPath:
			ptype = "CustomScan";
			subpath_list = ((CustomPath *) path)->custom_paths;
			extra_info = ((CustomPath *) path)->methods->CustomName;
			break;
		case T_NestPath:
			ptype = "NestLoop";
			join = true;
		...
		case T_AppendPath:
			ptype = "Append";
			subpath_list = ((AppendPath *) path)->subpaths;
			break;
		case T_MergeAppendPath:
			ptype = "MergeAppend";
			subpath_list = ((MergeAppendPath *) path)->subpaths;
			break;
		case T_ResultPath:
			ptype = "Result";
			break;
		...
		case T_ModifyTablePath:
			ptype = "ModifyTable";
			subpath_list = ((ModifyTablePath *) path)->subpaths;
			break;
		case T_LimitPath:
			ptype = "Limit";
